...
int main(int argc, char **argv, char **envp)
{
    ...
    */
    ...
    puts("### Level 0\n");
    puts("Wellcome to shellcode level2.");
    puts("This challenge reads in much fewer bytes. Try read the flag at '/flag'\n");
    ...
    puts("\nReading 0x18 bytes from stdin.\n");

    shellcode_size = read(0, shellcode_mem, 0x18);
